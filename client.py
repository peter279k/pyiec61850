...
if __name__ == "__main__":
    ...
    if error == iec61850.IED_ERROR_OK:
        ...
        while running:
            ...
            assert value[1] == 0
            newValue = value[0]
            err = iec61850.IedConnection_writeFloatValue(
            ...
            assert value1[1] == 0
            newValue1 = value1[0]
            err1 = iec61850.IedConnection_writeVisibleStringValue(
                con, theVal1, theValType1, newValue1
            )
            assert err1 == 21
            ...
            setpoint1 = iec61850.IedConnection_readStringValue(
                con, theVal1, theValType1
            )
            assert value1[1] == 0
